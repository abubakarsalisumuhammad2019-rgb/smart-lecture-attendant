  ...
  return (
    <>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input value={profile.matric_number || ''} disabled className="h-11 px-3 border border-gray-200 rounded-xl text-sm w-full bg-gray-100 text-gray-500" />
          </div>
          <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              <option value="">{department ? 'Select programme' : 'Select a department first'}</option>
              {getProgrammesForDepartment(department).map((prog) => (
      ...
      >
        ...
        {passwordMessage && (
          <div className="bg-blue-50 text-blue-700 text-sm rounded-xl px-4 py-2 mb-4 mt-4">{passwordMessage}</div>
        )}
