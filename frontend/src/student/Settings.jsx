      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input value={profile.programme || ''} disabled className="h-11 px-3 border border-gray-200 rounded-xl text-sm w-full bg-gray-100 text-gray-500" />
            <p className="text-[11px] text-gray-400">Contact an admin to change your programme.</p>
          </div>
          <div className="flex flex-col gap-1">
